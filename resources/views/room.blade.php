...
<head>
    ...
    <title>Luxuery HoStel by CHIKIMIKI</title>
...
<body>
    ...
    <header class="site-header js-site-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="index.html">CHIKI-MIKI HOSTEL</a></div>
        ...
        <div class="container">
            <div class="row site-hero-inner justify-content-center align-items-center">
                <div class="col-md-10 text-center" data-aos="fade">
                    <h1 class="heading mb-3">Select Rooms Where You Feel Comfortable</h1>
    ...
    <section class="section">
        <div class="container">
            ...
            <form action="selected-room" method="post">
                @csrf
                <div class="row">

                    <div class="col-md-4 mb-3" data-aos="fade-up">
                        <label for="single-room">
                            <input type="radio" name="selected_room" id="single-room" value="Single Room">
                            <a href="#" class="room">
                                ...
                                <div class="p-3 text-center room-info">
                                    <h2>Single Room</h2>
                                    <span class="text-uppercase letter-spacing-1">120$ / per Month</span>
                                </div>
                            </a>
                        </label>
                    </div>
                    ...
                    <div class="col-md-4 mb-5" data-aos="fade-up">
                        <label for="luxury-two-seater">
                            <input type="radio" name="selected_room" value="Two Seater Room">
                            <a href="#" class="room">
                                <figure class="img-wrap">
                                    <img src="images/img_2.jpg" alt="Free website template" class="img-fluid mb-3">
                                </figure>
                                <div class="p-3 text-center room-info">
                                    <h2>Two Seater Room</h2>
                                    <span class="text-uppercase letter-spacing-1">250$ / per Month</span>
                                </div>
                            </a>
                        </label>
                    </div>
                    ...
                    <div class="col-md-4 mb-5" data-aos="fade-up">
                        <label for="three-seater">
                            <input type="radio" name="selected_room" value="Three Seater Room">
                            <a href="#" class="room">
                                <figure class="img-wrap">
                    ...
                    <div class="mb-5">
                        <button class="btn btn-primary  border border-2" type="submit">Submit Selection</button>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <form action="selected-room" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3" data-aos="fade-up">
                        <label for="single-room">
                            <input type="radio" name="selected_room" id="single-room" value="Single Room Ac">
                            <a href="#" class="room">
                                <figure class="img-wrap">
                                    <img src="images/img_1.jpg" alt="Free website template" class="img-fluid mb-3">
                                </figure>
                                <div class="p-3 text-center room-info">
                                    <h2>Single Room Ac</h2>
                                    <span class="text-uppercase letter-spacing-1">120$ / per Month</span>
                                </div>
                            </a>
                        </label>
                    ...
                    <div class="col-md-4 mb-5" data-aos="fade-up">
                        <label for="luxury-two-seater">
                            <input type="radio" name="selected_room" value="Two Seater Room Ac">
                            <a href="#" class="room">
                                <figure class="img-wrap">
                                    <img src="images/img_2.jpg" alt="Free website template" class="img-fluid mb-3">
                                </figure>
                                <div class="p-3 text-center room-info">
                                    <h2>Two Seater Room Ac</h2>
                                    <span class="text-uppercase letter-spacing-1">250$ / per Month</span>
                                </div>
                            </a>
                        </label>
                    ...
                    <div class="col-md-4 mb-5" data-aos="fade-up">
                        <label for="three-seater">
                            <input type="radio" name="selected_room" value="Three Seater Room Ac">
                            <a href="#" class="room">
                                <figure class="img-wrap">
                                    <img src="images/img_3.jpg" alt="Free website template" class="img-fluid mb-3">
                                </figure>
                                <div class="p-3 text-center room-info">
                                    <h2>Three Seater Room Ac</h2>
                                    <span class="text-uppercase letter-spacing-1">120$ / per Month</span>
                                </div>
                            </a>
                        </label>
