        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <form action="reservation-form" method="post" class="bg-white p-md-5 p-4 mb-5 border">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <input type="email" id="email_adress" name="email" class="form-control">
                            </div>
                        </div>
                        ...
                        @if ($checkseat)
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    <label class="text-black font-weight-bold" for="bookingdate">Booking Date</label>
                                    <input type="text" id="bookingdate" name="bookingdate"
                                        value="{{$checkseat->bookingdate}}"class="form-control">
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label class="text-black font-weight-bold" for="selected-room">Selected Room</label>
                                <input type="text" id="selected-room" name="selected_room"
                                    value="{{ $selectedroom->selected_room }}" class="form-control">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label for="adults" class="font-weight-bold text-black">Mess</label>
                                <div class="field-icon-wrap">
                                    <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                                    <select name="mess" id="adults" class="form-control">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12 form-group">
                                <label class="text-black font-weight-bold" for="message">Any Complain</label>
                                <textarea name="complain" id="message" class="form-control" cols="30" rows="8"></textarea>
                            </div>
                        </div>
                ...
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="row">
                        <img src="images/hostel menu.jpg" alt="hostel-menu">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12" data-aos="fade-up" data-aos-delay="200">
                <div class="row">
                    <div class="col-md-10 ml-auto contact-info">
                        <p><span class="d-block">Address:</span> <span class="text-black">Wadat Road New Muslim Town
                                Near Decent Departmental Store Lahore</span></p>
                        <p><span class="d-block">Phone:</span> <span class="text-black">(+92)3013971193</span></p>
                        <p><span class="d-block">Email:</span> <span class="text-black">Kashianjum81@gmail.com</span>
                        </p>
                    </div>
                </div>
            </div>
